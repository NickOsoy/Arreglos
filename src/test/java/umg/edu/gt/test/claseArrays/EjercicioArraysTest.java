...
public class EjercicioArraysTest {
    ...
    public void testEncontrarClienteMasRico() {
        ...
        logger.info("Resultado Cliente Mas Rico ejemplo 1: {}", resultado1);
        ...
        logger.info("Resultado Cliente Mas Rico ejemplo 2: {}", resultado2);
        ...
        logger.error("Resultado Cliente Mas Rico ejemplo forzar fallo: {}", resultado3);
    ...
    public void testOrdenarDiagonales() {
        ...
        logger.info("Resultado Diagonales ejemplo 1: {}", Arrays.deepToString(resultado1));
        ...
        logger.error("Resultado Diagonales Forzar fallo: {}", Arrays.deepToString(resultado2));
    ...
    public void testSumaMatriz() {
        ...
        logger.info("Resultado Suma Matriz ejemplo 1: {}", resultado1);
        ...
        logger.info("Resultado Suma Matriz ejemplo 2: {}", resultado2);
        ...
        logger.error("Resultado Suma Matriz ejemplo 3 Forzar fallo: {}", resultado3);
